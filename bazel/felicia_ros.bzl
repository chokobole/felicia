...
def _ros_msg_gen(ctx):
    ...
    tool_path = ctx.expand_location("$(location @com_github_chokobole_felicia//tools:ros_msg_gen.py)", [ctx.attr._tool])
...
ros_msg_gen = rule(
    ...
    attrs = {
        "_tool": attr.label(
            ...
            executable = True,
            default = Label("@com_github_chokobole_felicia//tools:ros_msg_gen.py"),
        ),
        "templates": attr.label_list(
            cfg = "host",
            allow_files = [".h.template"],
            default = [
                Label("@com_github_chokobole_felicia//tools:ros/msg.h.template"),
                Label("@com_github_chokobole_felicia//tools:ros/srv.h.template"),
            ],
        ),
