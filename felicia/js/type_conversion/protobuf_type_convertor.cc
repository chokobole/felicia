  ...
  switch (field_desc->type()) {
    case google::protobuf::FieldDescriptor::TYPE_DOUBLE: {
      if (field_desc->is_repeated()) {
        ...
        Napi::Array array = Napi::Array::New(env, repeated_field_ref.size());
        for (int i = 0; i < repeated_field_ref.size(); ++i) {
          array[i] = Napi::Number::New(env, repeated_field_ref.Get(i));
        }
        return array;
      }
      return Napi::Number::New(env, reflection->GetDouble(message, field_desc));
    }
    case google::protobuf::FieldDescriptor::TYPE_FLOAT:
      ...
      return Napi::Number::New(env, reflection->GetFloat(message, field_desc));
    ...
    case google::protobuf::FieldDescriptor::TYPE_SINT64: {
      ...
      return Napi::Number::New(env, reflection->GetInt64(message, field_desc));
    }
    ...
    case google::protobuf::FieldDescriptor::TYPE_FIXED64: {
      ...
      return Napi::Number::New(env, reflection->GetUInt64(message, field_desc));
    }
    ...
    case google::protobuf::FieldDescriptor::TYPE_SINT32: {
      ...
      return Napi::Number::New(env, reflection->GetInt32(message, field_desc));
    }
    ...
    case google::protobuf::FieldDescriptor::TYPE_UINT32: {
      ...
      return Napi::Number::New(env, reflection->GetUInt32(message, field_desc));
    }
    case google::protobuf::FieldDescriptor::TYPE_BOOL: {
      ...
      return Napi::Boolean::New(env, reflection->GetBool(message, field_desc));
    }
    ...
    case google::protobuf::FieldDescriptor::TYPE_BYTES: {
      if (field_desc->is_repeated()) {
        ...
        for (int i = 0; i < repeated_field_ref.size(); ++i) {
          ...
          array[i] = Napi::Uint8Array::New(env, data.length(), arrayBuffer, 0);
        }
        return array;
      }
      std::string scratch;
