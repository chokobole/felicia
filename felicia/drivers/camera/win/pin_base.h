...
#ifndef FELICIA_DRIVERS_CAMERA_WIN_PIN_BASE_H_
#define FELICIA_DRIVERS_CAMERA_WIN_PIN_BASE_H_
...
class PinBase : public IPin,
 ...
 public:
  ...
  (REFERENCE_TIME start, REFERENCE_TIME stop, double dRate) override;
  ...
  (IMediaSample** samples, long sample_count, long* processed) override;
