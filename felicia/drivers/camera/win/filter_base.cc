...
// https://github.com/chromium/chromium/blob/5db095c2653f332334d56ad739ae5fe1053308b1/media/capture/video/win/filter_base_win.cc
...
class PinEnumerator final : public IEnumPins,
 ...
 public:
  ...
  STDMETHOD(Next)(ULONG count, IPin** pins, ULONG* fetched) override {
    ...
    if (fetched) *fetched = pins_fetched;
...
STDMETHODIMP FilterBase::FindPin(LPCWSTR id, IPin** pin) { return E_NOTIMPL; }
...
STDMETHODIMP FilterBase::QueryVendorInfo(LPWSTR* pVendorInfo) { return S_OK; }
...
STDMETHODIMP FilterBase::SetSyncSource(IReferenceClock* clock) { return S_OK; }
