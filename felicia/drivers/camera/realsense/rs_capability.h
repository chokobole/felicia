#ifndef FELICIA_DRIVERS_CAMERA_REALSENSE_RS_CAPABILITY_H_
#define FELICIA_DRIVERS_CAMERA_REALSENSE_RS_CAPABILITY_H_
...
#endif  // FELICIA_DRIVERS_CAMERA_REALSENSE_RS_CAPABILITY_H_