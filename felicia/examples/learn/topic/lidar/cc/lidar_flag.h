#ifndef FELICIA_EXAMPLES_LEARN_TOPIC_LIDAR_CC_LIDAR_FLAG_H_
#define FELICIA_EXAMPLES_LEARN_TOPIC_LIDAR_CC_LIDAR_FLAG_H_
...
#endif  // FELICIA_EXAMPLES_LEARN_TOPIC_LIDAR_CC_LIDAR_FLAG_H_