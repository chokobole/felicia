#ifndef FELICIA_EXAMPLES_LEARN_TOPIC_STEREO_CAMERA_CC_STEREO_CAMERA_FLAG_H_
#define FELICIA_EXAMPLES_LEARN_TOPIC_STEREO_CAMERA_CC_STEREO_CAMERA_FLAG_H_
...
#endif  // FELICIA_EXAMPLES_LEARN_TOPIC_STEREO_CAMERA_CC_STEREO_CAMERA_FLAG_H_