#ifndef FELICIA_EXAMPLES_LEARN_TOPIC_COMMON_CC_CAMERA_FLAG_H_
#define FELICIA_EXAMPLES_LEARN_TOPIC_COMMON_CC_CAMERA_FLAG_H_
...
#endif  // FELICIA_EXAMPLES_LEARN_TOPIC_COMMON_CC_CAMERA_FLAG_H_