#ifndef FELICIA_PYTHON_UTIL_PY_FLAG_PARSER_DELEGATE_H_
#define FELICIA_PYTHON_UTIL_PY_FLAG_PARSER_DELEGATE_H_
...
#endif  // FELICIA_PYTHON_UTIL_PY_FLAG_PARSER_DELEGATE_H_