...
// value.
#ifndef FELICIA_CORE_LIB_ERROR_STATUSOR_H_
#define FELICIA_CORE_LIB_ERROR_STATUSOR_H_
...
template <typename T>
StatusOr<T>::StatusOr() : Base(Status(felicia::error::UNKNOWN, "")) {}
...
#endif  // FELICIA_CORE_LIB_ERROR_STATUSOR_H_
