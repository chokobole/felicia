...
#ifndef FELICIA_CORE_ERROR_STATUSOR_INTERNALS_H_
#define FELICIA_CORE_ERROR_STATUSOR_INTERNALS_H_
...
#endif  // FELICIA_CORE_ERROR_STATUSOR_INTERNALS_H_
