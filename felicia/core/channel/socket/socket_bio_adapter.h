...
// https://github.com/chromium/chromium/blob/5db095c2653f332334d56ad739ae5fe1053308b1/net/socket/socket_bio_adapter.h

#if !defined(FEL_NO_SSL)

#ifndef FELICIA_CORE_CHANNEL_SOCKET_SOCKET_BIO_ADAPTERP_H_
#define FELICIA_CORE_CHANNEL_SOCKET_SOCKET_BIO_ADAPTERP_H_
...
#include "third_party/chromium/net/base/net_export.h"
...
class SocketBIOAdapter {
 public:
  ...
  SocketBIOAdapter(StreamSocket* socket, int read_buffer_capacity,
                   int write_buffer_capacity, Delegate* delegate);
  ~SocketBIOAdapter();
 ...
 private:
  ...
  // The pointer is non-owning so this class may be used with Socket
...
#endif  // FELICIA_CORE_CHANNEL_SOCKET_SOCKET_BIO_ADAPTERP_H_
