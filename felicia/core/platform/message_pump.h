#ifndef FELICIA_CORE_PLATFORM_MESSAGE_PUMP_H_
#define FELICIA_CORE_PLATFORM_MESSAGE_PUMP_H_

#include "felicia/core/lib/base/export.h"

#include "absl/time/time.h"

class EXPORT MessagePumpBase {
 public:
  ...
  class EXPORT Delegate {
   public:
    ...
    virtual bool DoDelayedWork(absl::Time* next_delayed_work_time) = 0;
  ...
  MessagePumpBase() = default;
  virtual ~MessagePumpBase() = default;
  ...
  virtual void ScheduleDelayedWork(const absl::Time delayed_work_time) = 0;
};

#include "felicia/core/lib/base/platform.h"
#if defined(PLATFORM_WINDOWS)
#include "felicia/core/platform/win/message_pump.h"
#elif defined(PLATFORM_POSIX)
#include "felicia/core/platform/posix/message_pump.h"
#else
